        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="flex-shrink-0">
            <div className="relative w-48 h-48 md:w-64 md:h-64">
              {/* Green glow effect behind picture */}
              <div className="absolute inset-0 bg-gradient-to-br from-primary/40 to-primary/20 rounded-full blur-2xl" />
              <div className="relative w-full h-full rounded-full overflow-hidden border-4 border-primary/30 shadow-2xl">
                <img
                  src="/professional-headshot.png"
                  alt="MD. Mustakim Hossain"
          ...
          <div className="space-y-8 text-center md:text-left">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed max-w-2xl">
              Final-year BSc student passionate about designing efficient and scalable solutions with hands-on
